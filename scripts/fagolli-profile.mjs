...
export const fagolliProfiles = {
  en: {
    ...
    blocks: [
      { type: "split", title: "Consider the gate as part of your entrance.", text: "Fagolli’s range includes aluminium swing gates, trackless bifold gates and motor systems such as the F2552. Compare the panel design and finish alongside the space needed for opening and parking. Remote controls and accessories are also part of the range; ask the team which options suit your gate and what is included in the proposed installation.", image, alt: "A Fagolli gate with white louvred panels, a dark frame and solar panels on the entrance pillars", route: "homeLiving", linkLabel: "Explore Home & Living" },
  ...
  ms: {
    ...
    datePublished: "2026-09-16",
    blocks: [
      { type: "split", title: "Padankan pagar dengan ruang masuk rumah.", text: "Rangkaian Fagolli merangkumi pagar ayun aluminium, pagar lipat tanpa rel dan sistem motor seperti F2552. Bandingkan reka bentuk panel serta kemasan dengan ruang yang diperlukan untuk membuka pagar dan meletakkan kereta. Alat kawalan jauh dan aksesori turut ditawarkan; tanya pasukan tentang pilihan yang sesuai dan perkara yang termasuk dalam cadangan pemasangan.", image, alt: "Pagar Fagolli dengan panel berbilah putih, bingkai gelap dan panel solar di atas tiang pintu masuk", route: "homeLiving", linkLabel: "Terokai Home & Living" },
  ...
  zh: {
    ...
    datePublished: "2026-09-16",
    blocks: [
      { type: "split", title: "把门闸与住宅入口一起规划。", text: "Fagolli的产品包括铝合金平开门闸、无轨折叠门闸，以及F2552等自动门驱动系统。比较门板设计与表面处理时，也要考虑开启所需的空间及停车位置。品牌另有遥控器与相关配件，可向团队了解哪些选项适合自家门闸，以及安装方案包含哪些项目。", image, alt: "Fagolli白色百叶门板配深色框架，入口门柱上装有太阳能板", route: "homeLiving", linkLabel: "查看家居生活品牌" },
