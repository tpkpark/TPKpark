...
export const builtopProfiles = {
  en: {
    ...
    blocks: [
      { type: "split", title: "Plan the design and the work together.", text: "BUILTOP’s services include interior design, design and build, renovation, construction and project management consultation. Whether you are adapting an existing home or fitting out business premises, start by explaining the space, the intended use and what needs to change. This gives the team a clearer basis for discussing the scope, materials and sequence of work.", image, alt: "Built-in timber shelving and a desk in BUILTOP’s Sunway Geo townhouse project", route: "homeLiving", linkLabel: "Explore Home & Living" },
  ...
  zh: {
    ...
    datePublished: "2026-09-16",
    blocks: [
      { type: "split", title: "把设计与施工放在一起规划。", text: "BUILTOP的服务涵盖室内设计、设计与施工、装修、建筑工程及项目管理咨询。无论是改造现有住宅，还是装修商业场所，都可先说明空间现况、计划用途及需要改变的部分，让团队更具体地讨论工程范围、材料与施工顺序。", image, alt: "BUILTOP的Sunway Geo联排住宅项目，展示木质内置书架与书桌", route: "homeLiving", linkLabel: "查看家居生活品牌" },
