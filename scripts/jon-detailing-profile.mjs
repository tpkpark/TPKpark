...
export const jonDetailingProfiles = {
  en: {
    ...
    blocks: [
      { type: "split", title: "Plan the finish, inside and out.", text: "A detailing visit starts with what you want to improve: the appearance of the paintwork, the condition of the cabin or the overall presentation of your car. Describe the areas that need attention and any previous surface treatments. Jon Detailing’s team can discuss your priorities and the work suited to the vehicle before you agree on a booking.", image, alt: "Two people attending to a red sports car with its door open at Jon Detailing", route: "automotive", linkLabel: "Explore Automotive" },
  ...
  zh: {
    ...
    business: jonDetailingBusiness, datePublished: "2026-09-16",
    blocks: [
      { type: "split", title: "从车内到车外，规划合适的护理。", text: "预约汽车美容前，可先想想希望改善哪些地方：漆面外观、车厢状况，或整辆车的整洁程度。说明需要处理的部位，以及车辆之前做过哪些表面护理。Jon Detailing团队可与你讨论关注重点及适合车辆的处理方式，再确认预约安排。", image, alt: "Jon Detailing现场，两人正在照料一辆车门打开的红色跑车", route: "automotive", linkLabel: "查看汽车服务" },
