...
export const techtricsAutoProfiles = {
  ...
  ms: {
    ...
    business: techtricsAutoBusiness, datePublished: "2026-09-16",
    blocks: [
      { type: "split", presentation: "renewal", title: "Fahami keperluan kereta anda.", text: "Sama ada untuk penyelenggaraan berkala atau mengenal pasti masalah, mulakan perbincangan dengan butiran kereta dan tujuan kunjungan anda. Techtrics Auto menyenaraikan jenama kontinental termasuk Mercedes-Benz, BMW, Audi dan Porsche. Maklumkan model, tahun dan masalah yang dialami supaya pasukan boleh memberi panduan tentang janji temu dan langkah seterusnya.", image, alt: "Bahagian hadapan bengkel Techtrics Auto yang bercahaya, dengan kereta di halaman dan ruang servis", caption: "Bahagian luar bengkel daripada arkib foto rasmi Techtrics Auto. Foto:", captionSource: imageSource, route: "automotive", linkLabel: "Terokai Automotif" },
  ...
  zh: {
    ...
    business: techtricsAutoBusiness, datePublished: "2026-09-16",
    blocks: [
      { type: "split", presentation: "renewal", title: "了解爱车需要哪些维护。", text: "无论是定期保养，还是检查某个故障，都可先说明车辆资料与到访目的。Techtrics Auto列出的欧系车品牌包括Mercedes-Benz、BMW、Audi和Porsche。告知团队车型、年份及你关注的问题，方便咨询预约安排与后续步骤。", image, alt: "灯光亮起的Techtrics Auto维修厂外观，前院与维修工位内停有多辆汽车", caption: "Techtrics Auto官方照片档案中的维修厂外观。图片来源：", captionSource: imageSource, route: "automotive", linkLabel: "查看汽车服务" },
