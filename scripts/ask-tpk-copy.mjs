...
const upgradeCopy = {
  en: {
    language: "Answer language", auto: "Auto", call: "Call the office", email: "Email the team", brochure: "Brochure (PDF)", details: "Property details", rentLabel: "Indicative asking rent", areaLabel: "Published area",
  ...
  ms: {
    language: "Bahasa jawapan", auto: "Auto", call: "Telefon pejabat", email: "E-mel pasukan", brochure: "Risalah (PDF)", details: "Butiran hartanah", rentLabel: "Sewa diminta indikatif", areaLabel: "Keluasan yang diterbitkan",
  ...
  zh: {
    language: "回答语言", auto: "自动", call: "致电办公室", email: "电邮团队", brochure: "资料包（PDF）", details: "物业详情", rentLabel: "参考叫租", areaLabel: "已公布面积",
