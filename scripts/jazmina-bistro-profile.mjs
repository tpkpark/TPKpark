...
export const jazminaBistroProfiles = {
  en: {
    ...
    blocks: [
      { type: "split", title: "An easy stop, at any hour.", text: "Jazmina Bistro suits a quick breakfast, a meal between appointments, a late-night bite or a casual sit-down with colleagues and family. The menu covers familiar Malaysian Indian Muslim staples and made-to-order rice and noodle dishes, from roti or tosai to nasi kandar, briyani and tomyam-style dishes.", image, alt: "Lifestyle businesses and visitor setting within TPK Park, Puchong", route: "lifestyle", linkLabel: "Explore Lifestyle" },
  ...
  zh: {
    ...
    datePublished: "2026-09-16",
    blocks: [
      { type: "split", title: "任何时候，都可以顺路吃一顿。", text: "无论是简单早餐、办事之间吃一顿、深夜想吃点东西，或与同事家人轻松用餐，Jazmina Bistro都提供较日常的选择。公开菜单涵盖常见的马来西亚印度穆斯林料理，以及现点现炒的饭面类，从roti、tosai到nasi kandar、briyani和冬炎风味料理都有选择。", image, alt: "蒲种TPK Park内的生活品味商家与访客环境", route: "lifestyle", linkLabel: "查看生活品味" },
