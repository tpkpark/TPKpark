...
export const dcMotoProfiles = {
  ...
  zh: {
    ...
    datePublished: "2026-09-16",
    blocks: [
      { type: "split", title: "从门闸的使用方式开始规划。", text: "DCMOTO的产品包括GFM975与GFM925门闸驱动系统、遥控器，以及红外线安全感应器等配件。兼容的配置也可选择太阳能供电及Digicraft Home连接功能。选购时，可先与安装人员讨论门闸的尺寸、重量及开启空间，再确认所选型号需要的供电方式与配件。", image, alt: "DCMoto电机与驱动臂安装在白墙旁的横条金属门闸上", route: "homeLiving", linkLabel: "查看家居生活品牌" },
