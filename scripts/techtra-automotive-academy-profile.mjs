...
export const techtraAcademyProfiles = {
  en: {
    ...
    blocks: [
      { type: "split", title: "Learn how modern vehicles work.", text: "Techtra’s published course options include automotive technology, automotive refinishing and short technical courses. Its training combines vehicle systems, diagnostics and workshop practice, with a focus on European vehicles. Discuss your interests and experience with the academy to understand which programme suits your goals.", image, alt: "A person wearing a Techtra Automotive Academy apron examines an orange vehicle in a workshop", route: "automotive", linkLabel: "Explore Automotive" },
  ...
  ms: {
    ...
    business: techtraAcademyBusiness, datePublished: "2026-09-16",
    blocks: [
      { type: "split", title: "Pelajari cara kenderaan moden berfungsi.", text: "Pilihan kursus yang disenaraikan oleh Techtra merangkumi teknologi automotif, kemasan semula dan pengecatan kenderaan serta kursus teknikal jangka pendek. Latihannya menggabungkan sistem kenderaan, diagnostik dan amali bengkel, dengan tumpuan pada kenderaan Eropah. Bincangkan minat dan pengalaman anda dengan akademi untuk memahami program yang sesuai dengan matlamat anda.", image, alt: "Seorang individu memakai apron Techtra Automotive Academy memeriksa kenderaan berwarna jingga di bengkel", route: "automotive", linkLabel: "Terokai Automotif" },
  ...
  zh: {
    ...
    business: techtraAcademyBusiness, datePublished: "2026-09-16",
    blocks: [
      { type: "split", title: "了解现代汽车如何运作。", text: "Techtra公布的课程选项包括汽车技术、汽车喷漆及短期技术课程。培训结合车辆系统、故障诊断与车间实操，并以欧系车辆为重点。向学院说明你的兴趣与经验，了解哪种课程更符合你的学习目标。", image, alt: "一名身穿Techtra Automotive Academy围裙的人在车间检查橙色车辆", route: "automotive", linkLabel: "查看汽车服务" },
