...
export const acesGymnasticAcademyProfiles = {
  ...
  ms: {
    ...
    datePublished: "2026-09-16",
    blocks: [
      { type: "split", title: "Bina asas yang kukuh.", text: "Bahan kelas yang diterbitkan Aces memberi tumpuan kepada gimnastik artistik untuk lelaki dan perempuan, dengan latihan berkaitan kekuatan, koordinasi, keseimbangan, kemahiran pergerakan, disiplin dan keyakinan. Tahap, kumpulan umur dan tempat kelas semasa boleh berubah, jadi hubungi akademi sebelum mendaftar.", image, alt: "Bahagian hadapan Lifestyle TPK Park di Puchong", route: "lifestyle", linkLabel: "Terokai Lifestyle" },
  ...
  zh: {
    ...
    datePublished: "2026-09-16",
    blocks: [
      { type: "split", title: "从基本功开始。", text: "Aces已发布的课程资料以男孩及女孩的竞技体操为主，并把力量、协调、平衡、身体动作技巧、纪律与自信列为训练重点。现有级别、年龄组及课程名额可能调整，报名之前应直接向学院确认。", image, alt: "蒲种TPK Park生活品味区街景", route: "lifestyle", linkLabel: "查看生活品味" },
