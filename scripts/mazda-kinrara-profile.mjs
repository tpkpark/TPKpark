...
export const mazdaKinraraProfiles = {
  en: {
    ...
    blocks: [
      { type: "split", presentation: "renewal", title: "A place to choose and care for your Mazda.", text: "Visit the showroom to discuss a Mazda that suits your everyday journeys, or contact the team about maintenance and parts for your current vehicle. The Kinrara branch also handles body and paint enquiries. Call ahead to arrange the right appointment and confirm which models, services or parts are available.", image, alt: "Persada Auto’s Mazda Kinrara entrance and service frontage in its 2016 branch announcement", caption: "Mazda Kinrara exterior, from the branch’s 2016 announcement. Photo:", captionSource: imageSource, route: "automotive", linkLabel: "Explore Automotive" },
  ...
  ms: {
    ...
    business: mazdaKinraraBusiness, datePublished: "2026-09-16",
    blocks: [
      { type: "split", presentation: "renewal", title: "Untuk memilih dan menjaga Mazda anda.", text: "Kunjungi bilik pameran untuk berbincang tentang Mazda yang sesuai dengan perjalanan harian anda, atau hubungi pasukan bagi urusan penyelenggaraan dan alat ganti kenderaan sedia ada. Cawangan Kinrara turut menerima pertanyaan pembaikan badan dan cat. Hubungi dahulu untuk mengatur janji temu serta mengesahkan ketersediaan model, perkhidmatan atau alat ganti.", image, alt: "Pintu masuk dan bahagian hadapan servis Mazda Kinrara dalam pengumuman cawangan Persada Auto pada 2016", caption: "Bahagian luar Mazda Kinrara, daripada pengumuman cawangan pada 2016. Foto:", captionSource: imageSource, route: "automotive", linkLabel: "Terokai Automotif" },
  ...
  zh: {
    ...
    business: mazdaKinraraBusiness, datePublished: "2026-09-16",
    blocks: [
      { type: "split", presentation: "renewal", title: "从选车到照顾你的Mazda。", text: "可到展厅了解适合日常出行的Mazda车款，也可联系团队，讨论现有车辆的保养与零件需求。Kinrara分行亦接受车身修复和喷漆咨询。出发前先致电安排合适的预约，并确认所需车款、服务或零件是否可供选择。", image, alt: "Persada Auto于2016年分行公告中展示的Mazda Kinrara入口及维修中心外观", caption: "Mazda Kinrara外观，照片刊于2016年分行公告。图片来源：", captionSource: imageSource, route: "automotive", linkLabel: "查看汽车服务" },
