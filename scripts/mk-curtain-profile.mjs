...
export const mkCurtainProfiles = {
  en: {
    ...
    blocks: [
      { type: "split", title: "See the fabric in your room’s context.", text: "MK Curtain’s range includes custom-made and ready-made curtains, sheers, roller and zebra blinds, wallpaper and curtain accessories. Bring a few photos of your room to compare colours, textures and how the fabrics hang. Ask the showroom team which samples are available and how to arrange an on-site measurement.", image, alt: "The MK Curtain TPK Park Puchong showroom, with its red MK Curtain sign above the glazed entrance", route: "homeLiving", linkLabel: "Explore Home & Living" },
  ...
  ms: {
    ...
    datePublished: "2026-09-16",
    blocks: [
      { type: "split", title: "Padankan fabrik dengan ruang anda.", text: "Rangkaian MK Curtain merangkumi langsir tempahan khas dan siap pakai, langsir nipis, bidai gulung dan zebra, kertas dinding serta aksesori langsir. Bawa beberapa foto ruang untuk membandingkan warna, tekstur dan cara fabrik jatuh apabila digantung. Tanya pasukan bilik pameran tentang sampel yang tersedia serta cara mengatur pengukuran di rumah.", image, alt: "Bilik pameran MK Curtain TPK Park Puchong dengan papan tanda MK Curtain berwarna merah di atas pintu masuk kaca", route: "homeLiving", linkLabel: "Terokai Home & Living" },
  ...
  zh: {
    ...
    datePublished: "2026-09-16",
    blocks: [
      { type: "split", title: "把面料放进空间里考虑。", text: "MK Curtain的产品系列包括定制与现成窗帘、纱帘、卷帘、斑马帘、墙纸及窗帘配件。带上房间照片，比较颜色、质感与面料的垂坠效果，再向TPK Park展厅团队询问现有样本，以及上门测量的安排。", image, alt: "MK Curtain TPK Park蒲种展厅的玻璃入口，上方是红底MK Curtain招牌", route: "homeLiving", linkLabel: "查看家居生活品牌" },
