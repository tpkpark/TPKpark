...
export const kia4sServiceProfiles = {
  ...
  zh: {
    ...
    business: kia4sServiceBusiness, datePublished: "2026-09-16",
    blocks: [
      { type: "split", title: "为下一次保养做好安排。", text: "无论是到期保养，还是需要检查某个问题，都可先向维修团队说明车辆状况与需求。Kia Puchong亦列有喷漆、车身修复及保险索赔咨询服务。出发前先致电安排合适的预约，并确认团队可为你的车辆处理哪些项目。", image, alt: "Kia Puchong维修中心内，两人在引擎盖打开的车辆旁讨论保养事项", route: "automotive", linkLabel: "查看汽车服务" },
