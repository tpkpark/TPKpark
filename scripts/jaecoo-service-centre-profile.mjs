...
export const jaecooServiceCentreProfiles = {
  en: {
    ...
    blocks: [
      { type: "split", presentation: "renewal", title: "Keep your next service well planned.", text: "A clear appointment starts with your model, mileage and the reason for your visit. Whether maintenance is due or you have a concern to discuss, contact the service team before bringing the car in. Ask which checks are needed, what the proposed work includes and how long the visit is likely to take.", image, alt: "Technicians carrying out diagnostic work during OMODA & JAECOO’s 2025 technical skills competition in Klang", caption: "Brand archive: diagnostic work at OMODA & JAECOO’s 2025 skills competition in Klang. Photo:", captionSource: imageSource, route: "automotive", linkLabel: "Explore Automotive" },
  ...
  ms: {
    ...
    business: jaecooServiceCentreBusiness, datePublished: "2026-09-16",
    blocks: [
      { type: "split", presentation: "renewal", title: "Rancang servis kereta dengan teratur.", text: "Mulakan perbincangan janji temu dengan model, bacaan perbatuan dan tujuan kunjungan anda. Sama ada penyelenggaraan sudah tiba masanya atau ada masalah yang ingin dibincangkan, hubungi pasukan servis sebelum membawa kereta. Tanya pemeriksaan yang diperlukan, perkara yang termasuk dalam cadangan kerja dan anggaran tempoh kunjungan.", image, alt: "Juruteknik menjalankan kerja diagnostik semasa pertandingan kemahiran teknikal OMODA & JAECOO 2025 di Klang", caption: "Arkib jenama: kerja diagnostik dalam pertandingan kemahiran OMODA & JAECOO 2025 di Klang. Foto:", captionSource: imageSource, route: "automotive", linkLabel: "Terokai Automotif" },
  ...
  zh: {
    ...
    business: jaecooServiceCentreBusiness, datePublished: "2026-09-16",
    blocks: [
      { type: "split", presentation: "renewal", title: "为下一次保养做好安排。", text: "预约时可先说明车型、行驶里程及到访目的。无论是到了保养时间，还是有车辆问题需要咨询，都可在送车前联系服务团队。询问需要进行哪些检查、建议项目包含什么，以及预计需要多长时间，方便安排当天行程。", image, alt: "技术人员在2025年巴生OMODA & JAECOO技术技能竞赛中进行车辆诊断作业", caption: "品牌档案：2025年巴生OMODA & JAECOO技术技能竞赛中的诊断作业。图片来源：", captionSource: imageSource, route: "automotive", linkLabel: "查看汽车服务" },
