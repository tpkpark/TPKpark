...
import { balensDesignProfiles } from "./balens-design-profile.mjs";
import { builtopProfiles } from "./builtop-profile.mjs";
...
import { techtraAcademyProfiles } from "./techtra-automotive-academy-profile.mjs";
import { jonDetailingProfiles } from "./jon-detailing-profile.mjs";
import { jaecooServiceCentreProfiles } from "./jaecoo-service-centre-profile.mjs";
import { toyokarProfiles } from "./toyokar-profile.mjs";
import { jazminaBistroProfiles } from "./jazmina-bistro-profile.mjs";
import { nuarinaProfiles } from "./nuarina-profile.mjs";
...
export const routeSlugs = {
  ...
  balensDesign: "home-living/balens-design",
  builtop: "home-living/builtop",
  ...
  signature: "home-living/signature",
  ...
  techtraAcademy: "automotive/techtra-automotive-academy",
  jonDetailing: "automotive/jon-detailing",
  jaecooServiceCentre: "automotive/jaecoo-service-centre",
  toyokar: "automotive/toyokar",
  lifestyle: "lifestyle",
  motd: "lifestyle/motd",
  jazminaBistro: "lifestyle/jazmina-bistro",
  nuarina: "lifestyle/nasi-lemak-nuarina",
...
export const seoTitles = {
  en: {
    ...
    balensDesign: "Balens Design Puchong | Interior Design & Renovation | TPK Park",
    builtop: "BUILTOP Puchong | Design, Renovation & Construction | TPK Park",
    ...
    signature: "Signature Bandar Kinrara | Kitchens & Wardrobes | TPK Park",
    ...
    techtraAcademy: "Techtra Automotive Academy Puchong | Courses | TPK Park",
    jonDetailing: "Jon Detailing Puchong | Car Detailing | TPK Park",
    jaecooServiceCentre: "Jaecoo Service Centre Puchong Kinrara | TPK Park",
    toyokar: "Toyokar Puchong Kinrara | Car Servicing & Repairs | TPK Park",
  ...
  ms: {
    ...
    balensDesign: "Balens Design Puchong | Reka Bentuk Dalaman | TPK Park",
    builtop: "BUILTOP Puchong | Reka Bentuk & Pembinaan | TPK Park",
    ...
    signature: "Signature Bandar Kinrara | Dapur & Almari Pakaian | TPK Park",
    ...
    techtraAcademy: "Techtra Automotive Academy Puchong | Kursus | TPK Park",
    jonDetailing: "Jon Detailing Puchong | Penjagaan Kereta | TPK Park",
    jaecooServiceCentre: "Pusat Servis Jaecoo Puchong Kinrara | TPK Park",
    toyokar: "Toyokar Puchong Kinrara | Servis & Pembaikan Kereta | TPK Park",
  ...
  zh: {
    ...
    balensDesign: "Balens Design蒲种室内设计与住宅装修 | TPK Park",
    builtop: "BUILTOP蒲种设计、装修与建筑工程 | TPK Park",
    ...
    signature: "Signature蒲种金銮厨房橱柜与衣柜展厅 | TPK Park",
    ...
    techtraAcademy: "Techtra Automotive Academy蒲种 | 汽车技术培训 | TPK Park",
    jonDetailing: "Jon Detailing蒲种金銮 | 汽车美容护理 | TPK Park",
    jaecooServiceCentre: "Jaecoo蒲种金銮服务中心 | 保养与售后咨询 | TPK Park",
    toyokar: "Toyokar蒲种金銮 | 汽车保养与维修 | TPK Park",
...
const routeLastModifiedOverrides = {
  ...
  lavino: "2026-09-15",
  gaHing: "2026-09-16",
  kucheBath: "2026-09-16",
  jubinBms: "2026-09-16",
  vHausLiving: "2026-09-16",
  balensDesign: "2026-09-16",
  builtop: "2026-09-16",
  ...
  techtraAcademy: "2026-09-16",
  jonDetailing: "2026-09-16",
  jaecooServiceCentre: "2026-09-16",
  toyokar: "2026-09-16",
  ...
  homeLiving: {
    ...
    blocks: [
      ...
      { type: "directory", kicker: "Business mix", title: "A practical renovation journey", text: "Tenant names and operating details may change; contact each business directly before visiting.", items: [
        ...
        ["Kitchen & Home Solutions", "Signature"], ["Curtains", "MK Curtain"], ["Curtains & Blinds", "Baagus"], ["Tools", "Total Tools"],
  ...
  lifestyle: {
    ...
    blocks: [
      { type: "directory", kicker: "Around the park", title: "Eat, move, learn and get things done", text: "Individual businesses manage their own programmes, bookings and opening hours.", items: [
        ...
        ["Swimming", "Optimum Swim School", "optimumSwimSchool"], ["Gymnastics", "Aces Gymnastic Academy"], ["Optical", "Forsee Lens"], ["Convenience", "99 Speedmart"], ["Wellness", "Happivilles"]
      ] },
...
const msPages = {
  ...
  homeLiving: {
    ...
    blocks: [
      ...
      { type: "directory", kicker: "Campuran perniagaan", title: "Perjalanan renovasi yang praktikal", text: "Nama penyewa dan waktu operasi boleh berubah; hubungi setiap perniagaan sebelum berkunjung.", items: [
        ["Perabot", "Lavino"], ["Dapur, Bilik Mandi & Jubin", "Ga Hing"], ["Dapur & Bilik Mandi", "Kuche + BaTH"], ["Jubin & Permukaan", "Jubin BMS"], ["Penyelesaian Dapur & Rumah", "Signature"], ["Langsir", "MK Curtain"], ["Langsir & Bidai", "Baagus"], ["Peralatan", "Total Tools"], ["Perabot", "V Haus Living"], ["Reka Bentuk & Bina", "Balens Design"], ["Penyelesaian Binaan", "BUILTOP"], ["Pintu & Pagar", "Premio Door"], ["Reka Bentuk Dalaman", "Choose Interior"], ["Kelengkapan Kabinet", "KLOT"], ["Sistem Pagar Automatik", "DC Moto"], ["Pagar Automatik Tanpa Rel", "Fagolli"]
      ] },
  ...
  lifestyle: {
    ...
    blocks: [
      { type: "directory", kicker: "Sekitar taman", title: "Makan, bergerak, belajar dan selesaikan urusan", text: "Setiap perniagaan mengurus program, tempahan dan waktu operasinya sendiri.", items: [["Makanan", "m.o.t.d"], ["Makanan", "Jazmina Bistro"], ["Makanan", "Nasi Lemak Daun Pisang Nuarina", "nuarina"], ["Makanan", "Yummy Nyonya Kitchen", "yummyNyonya"], ["Renang", "Optimum Swim School", "optimumSwimSchool"], ["Gimnastik", "Aces Gymnastic Academy"], ["Optik", "Forsee Lens"], ["Kedai Serbaneka", "99 Speedmart"], ["Kesejahteraan", "Happivilles"]] },
...
const zhPages = {
  ...
  lifestyle: {
    ...
    blocks: [
      { type: "directory", kicker: "园区周边", title: "用餐、运动、学习与处理日常事务", text: "各商家自行管理课程、预约及营业时间。", items: [["餐饮", "m.o.t.d"], ["餐饮", "Jazmina Bistro"], ["餐饮", "Nasi Lemak Daun Pisang Nuarina", "nuarina"], ["餐饮", "Yummy Nyonya Kitchen", "yummyNyonya"], ["游泳", "Optimum Swim School", "optimumSwimSchool"], ["体操", "Aces Gymnastic Academy"], ["眼镜", "Forsee Lens"], ["便利店", "99 Speedmart"], ["健康", "Happivilles"]] },
