...
export const kucheBathProfiles = {
  en: {
    ...
    blocks: [
      { type: "split", presentation: "renewal", title: "Choose around everyday routines.", text: "KBO’s catalogue includes cooker hoods, hobs and ovens, kitchen sinks and taps, as well as bathroom basins, showers, toilets and vanity cabinets. Start with how you use the space: cooking, washing up or getting ready in the morning. A shortlist can help you compare the dimensions, controls and finishes that matter to you. Ask the Puchong team which models are available to view.", image, alt: "Kuche + BaTH Outlet storefront in Puchong, from KBO’s website banner", caption: "The Puchong storefront, as shown in KBO’s website banner. Image:", captionSource: imageSource, route: "homeLiving", linkLabel: "Explore Home & Living" },
  ...
  zh: {
    ...
    datePublished: "2026-09-15",
    blocks: [
      { type: "split", presentation: "renewal", title: "从日常使用出发。", text: "KBO的产品目录涵盖抽油烟机、炉灶、烤箱、厨房水槽与水龙头，以及浴室面盆、淋浴设备、马桶和浴室柜。选购时，可以先想想烹饪、洗碗或早晨梳洗的使用习惯，再列出初步清单，比较合适的尺寸、操作方式与饰面。出发前，向蒲种门店确认想看的型号是否正在展示。", image, alt: "KBO官网横幅中的Kuche + BaTH Outlet蒲种门面", caption: "KBO官网横幅展示的蒲种门面。图片来源：", captionSource: imageSource, route: "homeLiving", linkLabel: "查看家居生活品牌" },
