...
export function assistantEnabled(env = process.env) {
  ...
  return env.TPK_AI_ENABLED === "1" || (env.VERCEL_ENV === "preview" && ["codex/ai-assistant", "codex/ask-tpk-upgrade", "codex/ask-tpk-voice", "codex/ask-tpk-disclosure-cleanup", "codex/ask-tpk-ai-disclosure"].includes(env.VERCEL_GIT_COMMIT_REF));
}
