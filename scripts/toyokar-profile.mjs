...
export const toyokarProfiles = {
  en: {
    ...
    blocks: [
      { type: "split", presentation: "renewal", title: "Understand what your car needs.", text: "A useful workshop conversation starts with how you use the car, its service history and any changes you have noticed. Whether you are arranging routine maintenance or investigating a fault, ask Toyokar to explain the checks, proposed work and estimate. Agree on the repair scope before work starts, and confirm when the team will update you.", image, alt: "A Toyokar technician carrying out repair work beside a vehicle raised on a workshop lift", caption: "Vehicle repair work at Toyokar’s workshop. Photo:", captionSource: imageSource, route: "automotive", linkLabel: "Explore Automotive" },
  ...
  ms: {
    ...
    business: toyokarBusiness, datePublished: "2026-09-16",
    blocks: [
      { type: "split", presentation: "renewal", title: "Fahami keperluan kereta anda.", text: "Mulakan perbincangan dengan cara anda menggunakan kereta, rekod servis dan perubahan yang diperhatikan. Sama ada untuk penyelenggaraan berkala atau pemeriksaan masalah, minta Toyokar menerangkan pemeriksaan, cadangan kerja dan anggaran kos. Persetujui skop pembaikan sebelum kerja dimulakan dan sahkan bila pasukan akan memberikan maklum balas.", image, alt: "Juruteknik Toyokar menjalankan kerja pembaikan di sisi kenderaan yang diangkat menggunakan lif bengkel", caption: "Kerja pembaikan kenderaan di bengkel Toyokar. Foto:", captionSource: imageSource, route: "automotive", linkLabel: "Terokai Automotif" },
  ...
  zh: {
    ...
    business: toyokarBusiness, datePublished: "2026-09-16",
    blocks: [
      { type: "split", presentation: "renewal", title: "先了解车辆需要哪些照顾。", text: "与维修团队沟通时，可以先说明日常用车情况、保养记录，以及最近留意到的变化。无论是安排定期保养，还是检查车辆故障，都可请Toyokar说明检查流程、建议项目及估价。施工前先确认维修范围，并约定团队提供进展的时间。", image, alt: "Toyokar技术人员在维修厂升降机旁为车辆进行维修", caption: "Toyokar维修厂内的车辆维修作业。图片来源：", captionSource: imageSource, route: "automotive", linkLabel: "查看汽车服务" },
