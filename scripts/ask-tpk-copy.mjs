...
const upgradeCopy = {
  en: {
    language: "Chat language", auto: "Auto", call: "Call the office", email: "Email the team", brochure: "Brochure (PDF)", details: "Property details", rentLabel: "Indicative asking rent", areaLabel: "Published area", builtUpLabel: "Built-up area", landAreaLabel: "Land / lot area",
    voiceStart: "Speak your question", voiceStop: "Stop listening", voiceListening: "Listening…", voiceReady: "Voice input added. Check the text, then send it.", voiceDenied: "Microphone access was not allowed. You can still type your question.", voiceNoSpeech: "I didn’t catch that. Tap the microphone to try again.", voiceError: "Voice input isn’t available right now. You can still type your question.", listen: "Listen", listenAnswer: "Listen to this answer", stopAudio: "Stop audio", aiVoiceNotice: "Playing an AI-generated voice, not a human voice.", playbackUnavailable: "Audio playback isn’t available right now. Please try again.",
    ...
    privacy: "Sending a question shares this conversation with OpenAI through Vercel to generate an answer. Please leave out personal or confidential details. The microphone uses your browser or device. Listen normally uses your device; for Mandarin or when a suitable voice is unavailable, only the answer text is sent through Vercel to OpenAI to create an AI-generated voice, not a human voice. Microphone audio is not sent to TPK Park or analytics. The site keeps up to three completed exchanges in this tab’s session storage for up to 90 minutes, across pages. New chat clears them; closing the tab normally clears session storage. The site does not retain transcripts or audio on its server or send chat text or draft contents to analytics. Usage protection stores temporary counters and a rotating network hash. Providers may retain service data under their policies. AI answers may be inaccurate, so confirm availability and leasing details with our team. Email drafts are for you to review and send; this chat cannot send an enquiry or confirm a viewing."
  },
  ms: {
    language: "Bahasa perbualan", auto: "Auto", call: "Telefon pejabat", email: "E-mel pasukan", brochure: "Risalah (PDF)", details: "Butiran hartanah", rentLabel: "Sewa diminta indikatif", areaLabel: "Keluasan yang diterbitkan", builtUpLabel: "Keluasan binaan", landAreaLabel: "Keluasan tanah / lot",
    voiceStart: "Tuturkan soalan anda", voiceStop: "Berhenti mendengar", voiceListening: "Sedang mendengar…", voiceReady: "Input suara ditambahkan. Semak teks, kemudian hantar.", voiceDenied: "Akses mikrofon tidak dibenarkan. Anda masih boleh menaip soalan.", voiceNoSpeech: "Suara tidak dapat dikesan. Ketik mikrofon untuk cuba lagi.", voiceError: "Input suara tidak tersedia sekarang. Anda masih boleh menaip soalan.", listen: "Dengar", listenAnswer: "Dengar jawapan ini", stopAudio: "Hentikan audio", aiVoiceNotice: "Memainkan suara janaan AI, bukan suara manusia.", playbackUnavailable: "Audio tidak dapat dimainkan sekarang. Sila cuba lagi.",
    ...
    privacy: "Menghantar soalan berkongsi perbualan ini dengan OpenAI melalui Vercel untuk menghasilkan jawapan. Elakkan maklumat peribadi atau sulit. Mikrofon menggunakan pelayar atau peranti anda. Dengar biasanya menggunakan peranti; untuk Mandarin atau apabila suara yang sesuai tiada, hanya teks jawapan dihantar melalui Vercel kepada OpenAI untuk menghasilkan suara AI, bukan suara manusia. Audio mikrofon tidak dihantar kepada TPK Park atau analitik. Laman menyimpan sehingga tiga pertukaran lengkap dalam storan sesi tab ini sehingga 90 minit, merentasi halaman. Sembang baharu memadamkannya; menutup tab biasanya mengosongkan storan sesi. Laman tidak menyimpan transkrip atau audio pada pelayannya atau menghantar teks sembang atau draf kepada analitik. Perlindungan penggunaan menyimpan kiraan sementara dan hash rangkaian yang berputar. Penyedia mungkin menyimpan data perkhidmatan mengikut dasar mereka. Jawapan AI mungkin tidak tepat, jadi sahkan ketersediaan dan butiran penyewaan dengan pasukan kami. Anda perlu menyemak dan menghantar draf e-mel sendiri; sembang ini tidak menghantar pertanyaan atau mengesahkan lawatan."
  },
  zh: {
    language: "对话语言", auto: "自动", call: "致电办公室", email: "电邮团队", brochure: "资料包（PDF）", details: "物业详情", rentLabel: "参考叫租", areaLabel: "已公布面积", builtUpLabel: "建筑面积", landAreaLabel: "土地／地段面积",
    voiceStart: "语音输入问题", voiceStop: "停止录音", voiceListening: "正在聆听…", voiceReady: "已加入语音输入。请检查文字后再发送。", voiceDenied: "未获准使用麦克风。您仍可输入问题。", voiceNoSpeech: "未能识别语音。请点击麦克风重试。", voiceError: "目前无法使用语音输入。您仍可输入问题。", listen: "朗读", listenAnswer: "朗读此回答", stopAudio: "停止朗读", aiVoiceNotice: "正在播放AI合成语音，并非真人声音。", playbackUnavailable: "目前无法播放语音，请重试。",
    ...
    privacy: "发送问题会通过Vercel将本次对话分享给OpenAI以生成回答。请勿提供个人或机密资料。麦克风使用浏览器或设备的语音识别。“朗读”通常使用设备语音；普通话或设备缺少合适语音时，只会通过Vercel将回答文字发送给OpenAI，生成AI合成语音，并非真人声音。麦克风音频不会发送至TPK Park或分析工具。网站在本标签页的会话存储中保留最多三轮完整对话，跨页面有效，最长90分钟。点击“新对话”可清除；关闭标签页通常会清除会话存储。网站服务器不保留对话记录或音频，也不会将对话或草稿内容发送至分析工具。使用保护仅保存临时计数和定期更换的网络哈希。服务提供商可能按其政策保留服务数据。AI回答可能不准确，请向团队确认当前供应及租赁详情。您须自行检查并发送电邮草稿；此对话不会发送咨询或确认看房预约。"
  }
};
