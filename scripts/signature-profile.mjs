...
export const signatureProfiles = {
  en: {
    ...
    blocks: [
      { type: "split", title: "Plan storage around everyday life.", text: "Signature’s range includes custom kitchen cabinets and wardrobes, with different layouts, door finishes and storage fittings. Think about how you cook, what you keep within reach and how much hanging or drawer space you need. Bring those priorities to the showroom, then ask which materials, cabinet systems and wardrobe options are available to compare.", image, alt: "An island kitchen design from Signature, with dark cabinet fronts and a bright worktop", route: "homeLiving", linkLabel: "Explore Home & Living" },
  ...
  zh: {
    ...
    datePublished: "2026-09-16",
    blocks: [
      { type: "split", title: "按日常习惯规划收纳。", text: "Signature的产品系列包括定制厨房橱柜与衣柜，提供不同布局、柜门饰面及收纳配件。先想想平时如何备餐、哪些物品需要随手拿取，以及需要多少挂衣或抽屉空间。带着这些重点到展厅讨论，再询问有哪些材料、橱柜系统与衣柜选项可供比较。", image, alt: "Signature的中岛厨房设计，深色柜门搭配浅色工作台面", route: "homeLiving", linkLabel: "查看家居生活品牌" },
