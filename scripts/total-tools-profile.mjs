...
export const totalToolsProfiles = {
  en: {
    ...
    blocks: [
      { type: "split", title: "Choose tools around the work you do.", text: "The TOTAL range includes cordless and corded power tools, hand tools, batteries and accessories. Start with the material and task: drilling a wall, assembling furniture or carrying out workshop repairs may call for different equipment. Browse the brand’s catalogue, then ask the Kinrara team which models, accessories and sets are available in store.", image, alt: "TOTAL brushless cordless drill with its fitted battery and an additional battery alongside it", route: "homeLiving", linkLabel: "Explore Home & Living" },
  ...
  ms: {
    ...
    datePublished: "2026-09-16",
    blocks: [
      { type: "split", title: "Pilih alat mengikut kerja yang dirancang.", text: "Rangkaian TOTAL merangkumi alat kuasa tanpa wayar dan berkabel, alat tangan, bateri serta aksesori. Mulakan dengan bahan dan jenis kerja: menggerudi dinding, memasang perabot atau membuat pembaikan di bengkel mungkin memerlukan peralatan yang berbeza. Lihat katalog jenama, kemudian tanya pasukan Kinrara tentang model, aksesori dan set yang tersedia di kedai.", image, alt: "Gerudi tanpa wayar tanpa berus TOTAL dengan bateri terpasang serta bateri tambahan di sebelahnya", route: "homeLiving", linkLabel: "Terokai Home & Living" },
  ...
  zh: {
    ...
    datePublished: "2026-09-16",
    blocks: [
      { type: "split", title: "从实际用途开始挑选工具。", text: "TOTAL的产品包括充电式与有线电动工具、手工具、电池及配件。先想清楚要处理的材料与工作：墙面钻孔、组装家具或车间维修，可能需要不同的设备。可先浏览品牌目录，再向Kinrara团队确认店内有哪些型号、配件及套装可供选择。", image, alt: "装有电池的TOTAL无刷充电式电钻，旁边另放一块电池", route: "homeLiving", linkLabel: "查看家居生活品牌" },
