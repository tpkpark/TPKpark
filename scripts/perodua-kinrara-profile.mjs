...
export const peroduaKinraraProfiles = {
  en: {
    ...
    blocks: [
      { type: "split", title: "From choosing a car to looking after it.", text: "A 3S centre combines sales, service and spare parts. At Kinrara, you can speak with a sales adviser about the current Perodua range and arrange a test drive, or contact the service department about your existing vehicle. The branch also accepts service appointment requests online; its service adviser will call to confirm the booking.", image, alt: "Perodua 3S Kinrara’s grey showroom facade, entrance and forecourt on Jalan TPK 2/3", route: "automotive", linkLabel: "Explore Automotive" },
  ...
  ms: {
    ...
    business: peroduaKinraraBusiness, datePublished: "2026-09-16",
    blocks: [
      { type: "split", title: "Daripada memilih kereta hingga menjaganya.", text: "Pusat 3S menggabungkan jualan, servis dan alat ganti. Di Kinrara, anda boleh berbincang dengan penasihat jualan tentang rangkaian Perodua semasa dan mengatur pandu uji, atau menghubungi jabatan servis mengenai kenderaan sedia ada. Cawangan ini turut menerima permohonan janji temu servis dalam talian; penasihat servis akan menghubungi anda untuk mengesahkan tempahan.", image, alt: "Fasad kelabu, pintu masuk dan ruang hadapan Perodua 3S Kinrara di Jalan TPK 2/3", route: "automotive", linkLabel: "Terokai Automotif" },
  ...
  zh: {
    ...
    business: peroduaKinraraBusiness, datePublished: "2026-09-16",
    blocks: [
      { type: "split", title: "从选车到日常保养。", text: "3S中心集合汽车销售、保养维修与零件服务。在Kinrara，可向销售顾问了解Perodua现有车款及安排试驾，也可联系维修部门，讨论现有车辆的保养需要。分行提供线上保养预约申请，提交后将由服务顾问致电确认。", image, alt: "Jalan TPK 2/3上的Perodua 3S Kinrara灰色建筑外墙、展厅入口及前方空地", route: "automotive", linkLabel: "查看汽车服务" },
