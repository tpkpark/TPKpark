...
export const chooseInteriorProfiles = {
  en: {
    ...
    blocks: [
      { type: "split", presentation: "renewal", title: "Connect the design with how the space works.", text: "Choose Interior’s published work includes commercial interiors, with services spanning design consultation, visualisation, detailing and project coordination. Its social portfolio also features kitchen and cabinetry ideas. Start by explaining how the space will be used, then discuss the layout, materials and work involved in bringing the design together.", image, alt: "A retail project by Choose Interior at KL East Mall, with framed shopfront panels, display lighting and carpet displays", caption: "Retail interior at KL East Mall, a Choose Interior project. Photo:", captionSource: imageSource, route: "homeLiving", linkLabel: "Explore Home & Living" },
  ...
  zh: {
    ...
    datePublished: "2026-09-16",
    blocks: [
      { type: "split", presentation: "renewal", title: "让设计配合空间的实际用途。", text: "Choose Interior公开的作品包括商业空间，所列服务涵盖设计咨询、效果图、细节设计与项目协调。其社交平台也分享厨房和柜体设计。初次讨论时，可先说明空间的使用方式，再一起考虑布局、材料，以及落实设计所涉及的工程。", image, alt: "Choose Interior在KL East Mall的零售项目，展示带框饰面的店面、陈列灯光及地毯展示区", caption: "Choose Interior位于KL East Mall的零售空间项目。图片来源：", captionSource: imageSource, route: "homeLiving", linkLabel: "查看家居生活品牌" },
