...
export const baagusProfiles = {
  ...
  zh: {
    ...
    datePublished: "2026-09-16",
    blocks: [
      { type: "split", title: "把采光、隐私与面料一起考虑。", text: "Baagus提供定制窗帘与纱帘，以及卷帘、斑马帘和木百叶帘等选择。比较面料质感、颜色与帘头样式时，也可讨论各个房间的采光与隐私需要。品牌另有窗帘轨道和电动选项，到访前可询问展厅有哪些样本与系统可供比较。", image, alt: "位于Jalan TPK 2/8的BAAGUS Bandar Kinrara店面，招牌列有窗帘、百叶帘与墙纸", route: "homeLiving", linkLabel: "查看家居生活品牌" },
